...
public class PedFileDriverTest extends AbstractResourceTest
{
	...
	{
		// 1 1 0 0 1 1 A A G T
		assertEquals('C', pedfd.getAllEntries().get(0).getBialleles().get(0).getAllele1());
		assertEquals('C', pedfd.getAllEntries().get(0).getBialleles().get(0).getAllele2());
		assertEquals('G', pedfd.getAllEntries().get(0).getBialleles().get(1).getAllele1());
		assertEquals('G', pedfd.getAllEntries().get(0).getBialleles().get(1).getAllele2());

		assertEquals('C', pedfd.getAllEntries().get(1).getBialleles().get(0).getAllele1());
		assertEquals('G', pedfd.getAllEntries().get(1).getBialleles().get(0).getAllele2());
		assertEquals('A', pedfd.getAllEntries().get(1).getBialleles().get(1).getAllele1());
		...
		assertEquals('G', pedfd.getAllEntries().get(5).getBialleles().get(1).getAllele1());
		assertEquals('G', pedfd.getAllEntries().get(5).getBialleles().get(1).getAllele2());
		...
		assertEquals('G', pedfd.getEntries(3, 6).get(1).getBialleles().get(1).getAllele2());
	}
